...
void RealSpace::forceOnM_(RefVec out, const ConstRefVec& in) const { out = in; }
...
void RealSpace::retractation_(RefVec out, const ConstRefVec& x,
                              const ConstRefVec& v) const
{
  out = x + v;
}

void RealSpace::pseudoLog_(RefVec out, const ConstRefVec& x,
...
void RealSpace::applyDiffRetractation_(RefMat out, const ConstRefMat& in,
...
void RealSpace::applyDiffPseudoLog0_(RefMat out, const ConstRefMat& in,
                                     const ConstRefVec&) const
{
  out = in;
}

void RealSpace::applyTransport_(RefMat out, const ConstRefMat& in,
                                const ConstRefVec&, const ConstRefVec&) const
{
  out = in;
}

void RealSpace::applyInvTransport_(RefMat out, const ConstRefMat& in,
                                   const ConstRefVec&, const ConstRefVec&) const
{
  out = in;
}

void RealSpace::applyInvTransportOnTheRight_(RefMat out, const ConstRefMat& in,
                                             const ConstRefVec&,
                                             const ConstRefVec&) const
{
  out = in;
...
bool RealSpace::isInTxM_(const ConstRefVec&, const ConstRefVec&,
                         const double&) const
{
  return true;
}

void RealSpace::forceOnTxM_(RefVec out, const ConstRefVec& in,
                            const ConstRefVec&) const
{
  out = in;
}
...
void RealSpace::getTrustMagnitude_(RefVec out) const { out = trustMagnitude_; }
...
std::unique_ptr<Manifold> RealSpace::getNewCopy_() const
{
