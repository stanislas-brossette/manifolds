...
RealSpace_Base RealSpace_Base::copy() const { return RealSpace_Base(*this); }
...
std::string RealSpace_Base::toString(const ConstRefVec& val,
...
void RealSpace_Base::retractation_(RefVec out, const ConstRefVec& x,
                                   const ConstRefVec& v) const
{
  out = x + v;
}

void RealSpace_Base::pseudoLog_(RefVec out, const ConstRefVec& x,
...
void RealSpace_Base::setZero_(RefVec out) const { out.setZero(); }
...
void RealSpace_Base::applyDiffRetractation_(RefMat out, const ConstRefMat& in,
...
void RealSpace_Base::applyDiffPseudoLog0_(RefMat out, const ConstRefMat& in,
                                          const ConstRefVec&) const
{
  out = in;
}

void RealSpace_Base::applyTransport_(RefMat out, const ConstRefMat& in,
                                     const ConstRefVec&,
                                     const ConstRefVec&) const
{
  out = in;
...
void RealSpace_Base::applyInvTransport_(RefMat out, const ConstRefMat& in,
                                        const ConstRefVec&,
                                        const ConstRefVec&) const
{
  out = in;
...
void RealSpace_Base::applyInvTransportOnTheRight_(RefMat out,
...
bool RealSpace_Base::isInTxM_(const ConstRefVec&, const ConstRefVec&,
                              const double&) const
{
  return true;
}

void RealSpace_Base::forceOnTxM_(RefVec out, const ConstRefVec& in,
                                 const ConstRefVec&) const
{
  out = in;
}
