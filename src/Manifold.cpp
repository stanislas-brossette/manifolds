...
namespace mnf
{
  ...
  ConstManifold::ConstManifold(std::shared_ptr<Manifold_Base> m)
    : ptr_(m)
  {}
  ...
  Point ConstManifold::createPoint() const
  {
  ...
  Point ConstManifold::getZero() const
  {
    return ptr_->getZero();
  }
  ...
  Index ConstManifold::dim() const
  {
    return ptr_->dim();
  }

  Index ConstManifold::tangentDim() const
  {
  ...
  void ConstManifold::retractation(RefVec out, const ConstRefVec& x, const ConstRefVec& v) const
  {
    return ptr_->retractation(out, x, v);
  }

  void ConstManifold::pseudoLog(RefVec out, const ConstRefVec& x, const ConstRefVec& y) const
  {
  ...
  void ConstManifold::applyDiffRetractation( RefMat out, const ConstRefMat& in, const ConstRefVec& x) const
  {
  ...
  void ConstManifold::applyDiffPseudoLog0(RefMat out, const ConstRefMat& in, const ConstRefVec& x) const
  {
    return ptr_->applyDiffPseudoLog0(out, in, x);
  }

  void ConstManifold::applyTransport(RefMat out, const ConstRefMat& in, const ConstRefVec& x, const ConstRefVec& v) const
  {
    return ptr_->applyTransport(out, in, x, v);
  }

  void ConstManifold::applyInvTransport(RefMat out, const ConstRefMat& in, const ConstRefVec& x, const ConstRefVec& v) const
  {
    return ptr_->applyInvTransport(out, in, x, v);
  }

  void ConstManifold::applyInvTransportOnTheRight(RefMat out, const ConstRefMat& in, const ConstRefVec& x, const ConstRefVec& v) const
  {
    return ptr_->applyInvTransportOnTheRight(out, in, x, v);
  }

  void ConstManifold::setZero(RefVec out) const
  {
  ...
  bool ConstManifold::isInTxM(const ConstRefVec& x, const ConstRefVec& v, const double& prec) const
  {
    return ptr_->isInTxM(x, v, prec);
  }

  void ConstManifold::forceOnTxM(RefVec out, const ConstRefVec& in, const ConstRefVec&x) const
  {
  ...
  void ConstManifold::limitMap(RefVec out) const
  {
  ...
  void ConstManifold::lock() const
  {
    return ptr_->lock();
  }

  bool ConstManifold::isLocked() const
  {
    return ptr_->isLocked();
  }

  const std::string& ConstManifold::name() const
  {
    return ptr_->name();
  }

  long ConstManifold::getInstanceId() const
  {
  ...
  bool ConstManifold::isElementary() const
  {
  ...
  {
    return ConstManifold(std::const_pointer_cast<Manifold_Base>(ptr_->operator()(i)));
  }

  long ConstManifold::getTypeId() const
  {
    return ptr_->getTypeId();
  }

  std::string ConstManifold::toString(const ConstRefVec& val, const std::string& prefix, const Eigen::IOFormat& fmt) const
  {
   ...
   ********************************/
  Manifold::Manifold(std::shared_ptr<Manifold_Base> p)
    : ConstManifold(p)
  {
  }
