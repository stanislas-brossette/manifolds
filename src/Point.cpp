...
ConstSubPoint::~ConstSubPoint() { unregisterPoint(); }
...
const Manifold& ConstSubPoint::getManifold() const { return manifold_; }
...
void ConstSubPoint::registerPoint() { this->manifold_.incrementRefCounter(); }

void ConstSubPoint::unregisterPoint() { this->manifold_.decrementRefCounter(); }
