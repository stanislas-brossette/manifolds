  ...
  public:
    ...
    { 
      printf("It appears that you're trying to call a method from a manifold that does not exist \
             anymore. Possible cause: the manifold was statically created in a scope (e.g. a \
             function) which was left since then. For Stan: https://www.youtube.com/watch?v=Yy8MUnlT9Oo\n"); 
      return false; }
  private:
    int flag_;
#endif
