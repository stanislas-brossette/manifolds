...
namespace mnf
{
  ...
  template<typename Map>
  inline std::string SO3_Base<Map>::toString(const ConstRefVec& val, const std::string& prefix, const Eigen::IOFormat& fmt) const
  {
  ...
  template<typename Map>
  inline void SO3_Base<Map>::retractation_(RefVec out, const ConstRefVec& x, const ConstRefVec& v) const
  {
    Map::retractation_(out, x, v);
  }

  template<typename Map>
  inline void SO3_Base<Map>::pseudoLog_(RefVec out, const ConstRefVec& x, const ConstRefVec& y) const
  {
  ...
  template<typename Map>
  inline Eigen::MatrixXd SO3_Base<Map>::diffRetractation_(const ConstRefVec& x) const
  {
    return Map::diffRetractation_(x);
  }

  template<typename Map>
  inline void SO3_Base<Map>::applyDiffRetractation_(RefMat out, const ConstRefMat& in, const ConstRefVec& x) const
  {
    Map::applyDiffRetractation_(out, in, x, bufferMap_);
  }

  template<typename Map>
  inline Eigen::MatrixXd SO3_Base<Map>::diffPseudoLog0_(const ConstRefVec& x) const
  {
    return Map::diffPseudoLog0_(x);
  }

  template<typename Map>
  inline void SO3_Base<Map>::applyDiffPseudoLog0_(RefMat out, const ConstRefMat& in, const ConstRefVec& x) const
  {
    Map::applyDiffPseudoLog0_(out, in, x, bufferMap_);
  }

  template<typename Map>
  inline void SO3_Base<Map>::applyTransport_(RefMat out, const ConstRefMat& in, const ConstRefVec& x, const ConstRefVec& v) const
  {
    Map::applyTransport_(out, in, x, v);
  }

  template<typename Map>
  inline void SO3_Base<Map>::applyInvTransport_(RefMat out, const ConstRefMat& in, const ConstRefVec& x, const ConstRefVec& v) const
  {
    Map::applyInvTransport_(out, in, x, v);
  }

  template<typename Map>
  inline void SO3_Base<Map>::applyInvTransportOnTheRight_(RefMat out, const ConstRefMat& in, const ConstRefVec& x, const ConstRefVec& v) const
  {
  ...
  template<typename Map>
  bool SO3_Base<Map>::isInTxM_(const ConstRefVec& x, const ConstRefVec& v, const double& prec) const
  {
    return Map::isInTxM_(x, v, prec);
  }

  template<typename Map>
  void SO3_Base<Map>::forceOnTxM_(RefVec out, const ConstRefVec& in, const ConstRefVec& x) const
  {
