...
class MANIFOLDS_API Manifold_Base
    : public std::enable_shared_from_this<Manifold_Base>
{
  friend Manifold;
 ...
 public:
  ...
  Manifold_Base(Index dimension, Index tangentDimension,
...
template <int D>
inline ConstSegment Manifold_Base::getConstView(const ConstRefVec& val,
                                                size_t i) const
{
  mnf_assert(i < numberOfSubmanifolds() && "invalid index");
  mnf_assert(val.size() == getDim<D>());
...
inline Index Manifold_Base::startR(size_t /*i*/) const { return 0; }

inline Index Manifold_Base::startT(size_t /*i*/) const { return 0; }

template <int Dr, int Dc>
inline typename ViewReturnType<Dr, Dc>::Type Manifold_Base::getView(
    RefMat val, size_t i) const
{
  return getView<Dr, Dc>(val, i, i);
}

template <int Dr, int Dc>
inline typename ConstViewReturnType<Dr, Dc>::Type Manifold_Base::getConstView(
    const ConstRefMat& val, size_t i) const
{
...
template <int Dr, int Dc>
inline typename ViewReturnType<Dr, Dc>::Type Manifold_Base::getView(
    RefMat val, size_t ir, size_t ic) const
{
...
template <>
inline typename ViewReturnType<F, R>::Type Manifold_Base::getView<F, R>(
...
template <>
inline typename ConstViewReturnType<F, R>::Type
Manifold_Base::getConstView<F, R>(const ConstRefMat& val, size_t,
                                  size_t ic) const
{
  return val.middleCols(getStart<R>(ic), getDim<R>(ic));
}
...
template <>
inline typename ViewReturnType<F, T>::Type Manifold_Base::getView<F, T>(
    RefMat val, size_t, size_t ic) const
{
...
template <>
inline typename ConstViewReturnType<F, T>::Type
Manifold_Base::getConstView<F, T>(const ConstRefMat& val, size_t,
                                  size_t ic) const
{
  return val.middleCols(getStart<T>(ic), getDim<T>(ic));
}
...
template <>
inline typename ViewReturnType<R, F>::Type Manifold_Base::getView<R, F>(
    RefMat val, size_t ir, size_t) const
{
  return val.middleRows(getStart<R>(ir), getDim<R>(ir));
}

template <>
inline typename ConstViewReturnType<R, F>::Type
Manifold_Base::getConstView<R, F>(const ConstRefMat& val, size_t ir,
                                  size_t) const
{
  return val.middleRows(getStart<R>(ir), getDim<R>(ir));
}
...
template <>
inline typename ViewReturnType<T, F>::Type Manifold_Base::getView<T, F>(
    RefMat val, size_t ir, size_t) const
{
...
template <>
inline typename ConstViewReturnType<T, F>::Type
Manifold_Base::getConstView<T, F>(const ConstRefMat& val, size_t ir,
                                  size_t) const
{
  return val.middleRows(getStart<T>(ir), getDim<T>(ir));
}
...
template <>
inline typename ViewReturnType<F, F>::Type Manifold_Base::getView<F, F>(
    RefMat val, size_t, size_t) const
{
  return val;
}

template <>
inline typename ConstViewReturnType<F, F>::Type
